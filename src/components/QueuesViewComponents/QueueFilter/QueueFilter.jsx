...
export class QueueFilter extends Component {
  ...
  handleSubmit = (event) => {
    ...
    this.dispatch(QueuesViewFilterActions.updatedSelectedQueues(this.state.selectedQueues));
  }
...
const mapStateToProps = (state) => {
  ...
  const selectedValues = state['supervisor-addons']?.queuesViewFilter?.selectedQueues;
  const queueValues = state['supervisor-addons']?.queuesViewFilter?.allQueues?.map(q => q.friendly_name) || [];
